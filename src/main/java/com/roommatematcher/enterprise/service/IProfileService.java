...
public interface IProfileService {
    /**
     * Fetch profiles with a given String gender.
    ...
    /**
     * Fetch profiles with a given smoking preference.
    ...
    /**
     * Fetch profiles with a given location.
    ...
    Profile fetchByCleanliness(Integer cleanlinessRating);
}
